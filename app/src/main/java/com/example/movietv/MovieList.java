...
public final class MovieList {
    ...
    private static List<com.example.movietv.Movie> list;
    private static long count = 0;

    public static List<com.example.movietv.Movie> getList() {
        if (list == null) {
            list = setupMovies();
        }
        return list;
    ...
    public static List<com.example.movietv.Movie> setupMovies() {
        list = new ArrayList<>();
        String title[] = {
        ...
        String studio[] = {
                "Crunchyroll Latinoamérica", "Studio One", "Studio Two", "Studio Three", "Studio Four"
        };
        String videoUrl[] = {
                "https://www.youtube.com/watch?v=6Tn55tBUdOE",
    ...
    private static com.example.movietv.Movie buildMovieInfo(
            String title,
            String description,
            String studio,
            String videoUrl,
        ...
        com.example.movietv.Movie movie = new com.example.movietv.Movie();
        movie.setId(count++);
